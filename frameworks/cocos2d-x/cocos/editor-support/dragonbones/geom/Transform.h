...
public:
	...
	inline Transform* lua_add(const Transform* v)
	{
		Transform value = *v;
		x += value.x;
		y += value.y;
	...
	inline Transform* lua_minus(const Transform* v)
	{
		Transform value = *v;
		x -= value.x;
		y -= value.y;
	...
	inline Transform* lua_fromMatrix(const Matrix* m)
	{
		const auto  backupScaleX = scaleX, backupScaleY = scaleY;
	...
	inline Transform* lua_toMatrix(Matrix* m)
	{
		Matrix matrix = *m;
