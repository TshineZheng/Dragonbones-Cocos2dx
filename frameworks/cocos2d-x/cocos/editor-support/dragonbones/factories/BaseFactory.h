...
public:
	...
	///////////////////////////////////////
	// Lua
	virtual void lua_replaceSlotDisplay(const std::string& dragonBonesName, const std::string& armatureName, const std::string& slotName, const std::string& displayName, Slot* slot, int displayIndex = -1) const;
	virtual void lua_replaceSlotDisplayList(const std::string& dragonBonesName, const std::string& armatureName, const std::string& slotName, Slot* slot) const;
	virtual bool lua_copyAnimationsToArmature(
		Armature* toArmature,
		const std::string& fromArmatreName, const std::string& fromSkinName = "", const std::string& fromDragonBonesDataName = "",
		bool ifRemoveOriginalAnimationList = true
	) const;
