...
void BaseFactory::lua_replaceSlotDisplay(const std::string& dragonBonesName, const std::string& armatureName, const std::string& slotName, const std::string& displayName, Slot* slot, int displayIndex) const
{
	BuildArmaturePackage dataPackage;
	if (_fillBuildArmaturePackage(dragonBonesName, armatureName, "", dataPackage))
	{
...
void BaseFactory::lua_replaceSlotDisplayList(const std::string& dragonBonesName, const std::string& armatureName, const std::string& slotName, Slot* slot) const
{
	BuildArmaturePackage dataPackage;
	if (_fillBuildArmaturePackage(dragonBonesName, armatureName, "", dataPackage))
	{
...
bool BaseFactory::lua_copyAnimationsToArmature(
	Armature* toArmature,
	const std::string& fromArmatreName, const std::string& fromSkinName, const std::string& fromDragonBonesDataName,
	bool ifRemoveOriginalAnimationList
) const
